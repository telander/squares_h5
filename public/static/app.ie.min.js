...
(function(a, b) {
    ...
    var f = e("Object");
    var g = e("String");
    var h = Array.isArray || e("Array");
    var i = e("Function");
    var j = d.log = function(b, c) {
        a.console && (c || Fb.debug) && console[c || (c = "log")] && console[c](b);
    };
    var k = d.events = {};
    d.on = function(a, b) {
        if (!b) return d;
    ...
    var O = K.getElementById("seajsnode") || N[N.length - 1];
    var P = M;
    function Q(a) {
    ...
    var R = K.getElementsByTagName("head")[0] || K.documentElement;
    var S = R.getElementsByTagName("base")[0];
    var T = /\.css(?:\?|$)/i;
    var U = /^(?:loaded|complete|undefined)$/;
    var V;
    var W;
    var X = navigator.userAgent.replace(/.*AppleWebKit\/(\d+)\..*/, "$1") * 1 < 536;
    function Y(a, c, d) {
        var e = T.test(a);
        var f = K.createElement(e ? "link" : "script");
        if (d) {
            var g = i(d) ? d(a) : d;
            if (g) {
                f.charset = g;
    ...
    function cb(a) {
        var b = [];
        a.replace(bb, "").replace(ab, function(a, c, d) {
            if (d) {
                b.push(d);
            }
        });
        ...
        for (var f = 0; f < d; f++) {
            (function(a) {
                ...
                if (c.dependencies.length) {
                    d(function(b) {
                        c.status < kb ? sb(a, d) : d();
                        function d() {
                            f(b);
                        }
                    });
                } else {
                    c.status < kb ? sb(a, d) : f();
                }
                function d(b) {
                    b || (b = f);
                    var d = xb(c.dependencies);
                    if (d.length === 0) {
                        b();
                    } else if (Ab(c)) {
                        Db(zb);
    ...
    function tb(a, c, d) {
        ...
        if (!e.uri && K.attachEvent) {
            var f = _();
            if (f) {
                e.uri = f.src;
            } else {
                j("Failed to derive: " + d);
            }
        }
        l("define", e);
        e.uri ? ub(e.uri, e) : eb = e;
    }
    function ub(a, c) {
        var d = wb(a);
        if (d.status < kb) {
            d.id = c.id || a;
            d.dependencies = pb(c.deps || [], a);
            d.factory = c.factory;
            if (d.factory !== b) {
                d.status = kb;
            }
    ...
    function vb(a) {
        ...
        var e = a.factory;
        var f = i(e) ? e(d, a.exports = {}, a) : e;
        a.exports = f === b ? a.exports : f;
        a.status = nb;
        return a.exports;
    }
    ...
    function Db(a) {
        a.push(a[0]);
        j("Circular dependencies: " + a.join(" -> "));
    }
    function Eb(a) {
        var b = Fb.preload;
        var c = b.length;
    ...
    d.resolve = J;
    a.define = tb;
    d.require = function(a) {
        return (db[J(a)] || {}).exports;
    };
    var Fb = Gb.data = {
        base: function() {
            var a = P;
            var b = a.match(/^(.+?\/)(?:seajs\/)+(?:\d[^/]+\/)?$/);
            if (b) {
                a = b[1];
            }
            return a;
    ...
    Gb({
        plugins: function() {
            var a;
            var b = L.search.replace(/(seajs-\w+)(&|$)/g, "$1=1$2");
            b += " " + K.cookie;
    ...
    var Ib = O.getAttribute("data-config");
    var Jb = O.getAttribute("data-main");
    if (Ib) {
        Fb.preload.push(Ib);
    }
    if (Jb) {
    ...
    if (c && c.args) {
        var Kb = [ "define", "config", "use" ];
        var Lb = c.args;
        for (var Mb = 0; Mb < Lb.length; Mb += 2) {
            d[Kb[Lb[Mb]]].apply(d, Lb[Mb + 1]);
        }
    }
})(this);
...
FastClick.prototype.onTouchEnd = function(a) {
    ...
    if (d === "label") {
        ...
        if (a.timeStamp - c > 100 || deviceIsIOS && window.top !== window && d === "input") {
            this.targetElement = null;
            return false;
        }
        this.focus(g);
        this.sendClick(g, a);
        if (!deviceIsIOS || d !== "select") {
            this.targetElement = null;
            a.preventDefault();
        }
        return false;
